...
mostrar.addEventListener("click", () => {
    ...
    switch (opcionSeleccionada) {
        case "carro":
            imagen.src = "carro.png"; // Ruta de la imagen del carro
            imagen.alt = "Imagen de un carro";
            break;
        case "moto":
            imagen.src = "moto.jpeg"; // Ruta de la imagen de la moto
            imagen.alt = "Imagen de una moto";
            break;
        case "bicicleta":
            imagen.src = "bicicleta.jpeg"; // Ruta de la imagen de la bicicleta
